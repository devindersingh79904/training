...
const Alert = ({ alerts }) => {
  ...
  var divStyle = {
    ...
    boxShadow: 'rgba(60, 184, 120, 0.8) 0px 0px 2px, rgba(0, 0, 0, 0.05) 0px 0px 0px 1px inset'
  };
  ...
  </div><div className="sa-icon sa-custom" style={{display: 'none',backgroundImage: 'url(&quot;dist/img/user.png&quot;)' ,width: '80px', height: '80px' }} ></div><h2>Error</h2>
  <p style={{display: 'block'}}><li>{alert.msg.toUpperCase()}</li></p>
  <fieldset>
    ...
    <div className="sa-confirm-button-container">
      <button className="confirm" tabIndex="1" style={{display: 'inline-block', backgroundColor: 'rgb(252, 176, 59)', boxShadow: 'rgba(252, 176, 59, 0.8) 0px 0px 2px, rgba(0, 0, 0, 0.05) 0px 0px 0px 1px inset'}}>Yes, delete it!</button><div className="la-ball-fall">
        ...
        case 'success':
          ...
          </div><div className="sa-icon sa-info" style={{display: "none"}}></div><div className="sa-icon sa-success animate" style={{display: 'block'}}>
            <span className="sa-line sa-tip animateSuccessTip"></span>
            <span className="sa-line sa-long animateSuccessLong"></span>
      
            <div className="sa-placeholder"></div>
            <div className="sa-fix"></div>
          </div><div className="sa-icon sa-custom" style={{display: "none"}}></div><h2>Success</h2>
