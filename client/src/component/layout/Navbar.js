      ...
      <ul className='nav navbar-right top-nav pull-right'>
        ...
        <li>
          <a id='open_right_sidebar' href='#'>
            <i className='fa fa-cog top-nav-icon'></i>
          </a>
        </li>
        ...
        <li className='dropdown'>
          <a href='#' className='dropdown-toggle' data-toggle='dropdown'>
            <i className='fa fa-bell top-nav-icon'></i>
              ...
              <div className='streamline message-box message-nicescroll-bar'>
                <div className='sl-item'>
                  ...
                  <div className='sl-content'>
                    <a
                      href='#'
                      className='inline-block capitalize-font  pull-left'
                    >
                      Sandy Doe
                    </a>
                    <span className='inline-block font-12  pull-right'>
                      12/10/16
                    </span>
        ...
        <li className='dropdown'>
          ...
          >
            ...
            <li>
              <a href='#'>
                <i className='fa fa-fw fa-credit-card-alt'></i> my balance
              </a>
            </li>
            <li>
              <a href='#'>
              ...
              <div className='input-group'>
                ...
                <span className='input-group-addon pr-30'>
                  <a
                    ...
                    data-target='#site_navbar_search'
